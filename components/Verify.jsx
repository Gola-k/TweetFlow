                ...
                <div id="contact-form">
                  <div class="row">
                    <div class="col-md-6 ">
                      <HiOutlineClipboardDocument
                        ...
                        onClick={(e) =>
                          navigator.clipboard.writeText("Twitter @crossfichain")
                        }
                      />
                      <div
                        class="form-grp"
                      ...
                      >
                        <input
                          type="text"
                          disabled
                          placeholder="Twitter @crossfichain"
                        />
                      </div>
                    </div>
                    <div class="col-md-6">
                      ...
                      <div class="form-grp">
                        <input
                          type="text"
                          disabled
                          placeholder="Instgram: @demon.rimuru.426"
                        />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <HiOutlineClipboardDocument
                        className="new-cursour"
                        onClick={(e) =>
                          navigator.clipboard.writeText("@crossFiToken Coin")
                        }
                      />
                      <div class="form-grp">
                        <input
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-grp">
                        <input
                          type="text"
                          disabled
                          placeholder="Website: https://crossfi.org/"
                        />
                      </div>
                    </div>
                  </div>
                  <div class="form-grp">
                    <HiOutlineClipboardDocument
                      ...
                      onClick={(e) =>
                        navigator.clipboard.writeText(
                          "🚀 Join the revolution! Introducing @crossFiToken, the future of decentralized finance and social impact. 💡 With every transaction, you're not just investing in a token, you're investing in positive change. 🌍 Let's empower communities, support sustainability, and drive meaningful impact together. Don't miss out on this opportunity to be part of something bigger than yourself. Invest in CrossToken today and make a difference while earning rewards! #@crossFiToken #crypto #crossFi #dapp 🌟🔗"
                        )
                      }
                    />
                    <textarea
                      name="message"
                      disabled
                      placeholder="🚀 Join the revolution! Introducing @crossFiToken, the future of decentralized finance and social impact. 💡 With every transaction, you're not just investing in a token, you're investing in positive change. 🌍 Let's empower communities, support sustainability, and drive meaningful impact together. Don't miss out on this opportunity to be part of something bigger than yourself. Invest in CrossToken today and make a difference while earning rewards! #@crossFiToken #crypto #crossFi #dapp 🌟🔗"
                    ></textarea>
                  </div>
